...
enum parameters {ELEMENT_LENGTH,CONST_T,CONST_K,CONST_V,PSI,ALFA,DELTA,CONST_N,LAMBDA};
...
class mesh{
    ...
    public:
        void setParameters(float l,float t,float k,float lamb,float v,float psi,float alfa,float delta,float n){
